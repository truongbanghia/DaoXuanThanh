					...
					<div class="col-md-4">
						...
						<table class="order-rable">
							<tbody>
								...
								<tr>
									<td>Địa chỉ</td>
									<td>: Km12+300 Ngọc Hồi, Thanh Trì, Hà Nội </td>
								</tr>
								<tr>
									<td>Thành Phố</td>
									<td>: Hà Nội</td>
								...
								<div class="order-list">
									...
									<div class="list-row d-flex justify-content-between">
										<div class="col-md-4">{{ $order->name }} 
											...
											@endforeach</div>
										<div class="col-md-4" align='right'>{{ $order->quantity }}</div>
										<div class="col-md-4" align='right'>{{ number_format($order->price*$order->quantity,0,'',',') }} VND</div>
